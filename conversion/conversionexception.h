 ...
 */
inline ConversionException::ConversionException() noexcept : runtime_error("unable to convert")
{
}
 ...
 */
inline ConversionException::ConversionException(const std::string &what) noexcept : runtime_error(what)
{
}
 ...
 *        describing the cause of the ConversionException.
 */
inline ConversionException::ConversionException(const char *what) noexcept : std::runtime_error(what)
{
}
